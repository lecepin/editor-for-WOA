  ...
  const plugins: BytemdPlugin[] = [
    ...
    },
    {
      ...
      actions: [
        {
          title: "预览",
          icon: `<svg xmlns="http://www.w3.org/2000/svg" width="200" height="200" class="icon" viewBox="0 0 1024 1024"><path fill="#0F9749" d="M457.143 621.714h109.714V768H457.143zM329.143 768h365.714a36.571 36.571 0 0 1 0 73.143H329.143a36.571 36.571 0 0 1 0-73.143z"/><path fill="#25B864" d="M237.714 182.857h548.572A73.143 73.143 0 0 1 859.429 256v329.143a73.143 73.143 0 0 1-73.143 73.143H237.714a73.143 73.143 0 0 1-73.143-73.143V256a73.143 73.143 0 0 1 73.143-73.143z"/><path fill="#FFF" d="m477.77 317.257 113.663 77.678a36.571 36.571 0 0 1 0 60.38L477.77 533.028a36.571 36.571 0 0 1-57.198-30.172V347.43a36.571 36.571 0 0 1 57.198-30.172z"/></svg>`,
          handler: {
            type: "action",
            async click() {
              location.href = location.href + '?p=1'
            },
          },
        },
      ],
